...
function openBookDescriptionPage(isbn) {
  if (defaultAPIEngine == "google") {
    if (googleAPIKey == "undefined") {
      transitionPageURL = "/liblend_app/bookDescription/google/?isbn=" + isbn + "&googleAPIKey=AIzaSyDd8uG2oo2ZLFx-z-mI1YBrOHCMEHM-R5o";
    }
    else {
      transitionPageURL = "/liblend_app/bookDescription/google/?isbn=" + isbn + "&googleAPIKey=" + googleAPIKey;
    }
  }
