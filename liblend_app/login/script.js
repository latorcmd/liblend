...
function challangeOrgAccess() {
  ...
  orgAccessURL = "https://script.google.com/macros/s/AKfycbyr69I6KwJTgwi_ioMhyluzqtZeV19eRvkyQpB2Yzgu0jUvh1Hbk10jHld7Rw236l65/exec?requestType=login&orgCode=" + orgCode;
  // サーバーと通信する
...
function challangeLoginAccess() {
   ...
   loginChallangeURL = UserSheetAppURL + "?requestType=loginChallange&userCode=" + userCode + "&password=" + password;
   // サーバーと通信する
